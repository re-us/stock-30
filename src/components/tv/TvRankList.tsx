...
export function TvRankList({ stocks, selectedId, onSelect }: TvRankListProps) {
  ...
  return (
    <section className="tv-rank-panel flex min-h-0 flex-col rounded-[28px] bg-gradient-to-br from-white via-white to-slate-100 p-5 shadow-[0_18px_45px_rgba(15,23,42,0.08)] ring-1 ring-black/5">
      ...
      <div className="grid min-h-0 flex-1 gap-1" style={{ gridTemplateRows: "repeat(30, minmax(0, 1fr))" }}>
        {displayStocks.map((stock, index) => {
          ...
          <button
            ...
            className={`tv-rank-row grid min-h-0 grid-cols-[48px_minmax(0,1fr)_140px_140px] items-center rounded-[16px] px-3 text-left transition-[transform,box-shadow,background-color] duration-500 ${
              isSelected
                ? "bg-gradient-to-r from-blue-50 via-white to-sky-50 shadow-[0_8px_20px_rgba(49,130,246,0.15),inset_0_1px_0_rgba(255,255,255,0.92)] ring-1 ring-blue-200"
                : "bg-gradient-to-r from-white via-[#fbfcff] to-slate-50 shadow-[0_3px_10px_rgba(15,23,42,0.055),inset_0_1px_0_rgba(255,255,255,0.88)] ring-1 ring-slate-200/70"
